...
function outputsegments = segmentImages(original_img_rotated,final_image,nn,Eccentricity,seg_width,out_DIR,seg_folder,imname,do_resize,numrows,numcols,factor_distance,display,saving)
...
imgfn = imname;
    ...
    for save_arr=1:seg_num-1
        ...
        if (sum(sum(sum(BW_small)))~=0)
            ...
            small_img=img_small_1_rotate(small_BoundingBox_1(2):small_BoundingBox_1(2)+small_BoundingBox_1(4),small_BoundingBox_1(1):small_BoundingBox_1(1)+small_BoundingBox_1(3),:);
